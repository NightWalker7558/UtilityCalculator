...
public class CustomerControllerTest {
  ...
  public static void main(String[] args) {
    ...
    // Add new customers
    boolean added1 = customerController.registerNewUser(
      "alice",
      "alice123",
      "alice@example.com"
    );
    boolean added2 = customerController.registerNewUser(
      "bob",
      "bob_password",
      "bob@example.com"
    );
    ...
    Customer foundCustomer = customerController.getCustomerByUsername(
      usernameToSearch
    );
    ...
    Customer loadedCustomer = customerController.loadCustomer(
      usernameToSearch,
      passwordToSearch
    );
